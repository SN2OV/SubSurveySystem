    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">车站详情(${station.stationName})</a></li>
                <%--<li class="active">十一月</li>--%>
            </ol>

            <h2 class="sub-header">车站详情</h2>

            <p>
                <button type="button" onclick="location = '/admin/stations/update/${station.sid}'"  class="btn btn-primary">修改车站</button>
                <button type="button" onclick="location = '/admin/stations/delete/${station.sid}'" class="btn btn-danger">删除车站</button>
            </p>
